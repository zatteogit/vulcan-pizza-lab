...
// [design-sync override] inlined from lib/common.mjs so this fork has no sibling dep.
...
function sharedBuildOptions({ nodePaths, tsconfig }) {
  ...
  return {
    ...
    loader: {
      '.svg': 'dataurl',
      // [design-sync override] raster assets stubbed: cms-context statically
      // imports STYLE_PHOTOS (~100MB of PNGs) that no synced component renders.
      '.png': 'empty',
      '.jpg': 'empty',
      '.jpeg': 'empty',
      '.webp': 'empty',

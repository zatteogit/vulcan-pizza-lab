...
export const DE_LOCALE: CmsContent = {
  ...
  ui: {
    ...
    statFlourStrength: "Mehlstärke",
    fermentEnvAmbient: "Raumtemp.",
    fermentEnvFridge: "Kühlschrank",
  ...
  misc: {
    ...
    inspirationBase: "Traditionell",
    inspirationSeeAll: "Alle ansehen",
    inspirationModalTitle: "Interpretationen der Meister",
    inspirationLearnLink: "Mehr im Bereich Lernen",
    inspirationSelect: "Auswählen",
    inspirationSelected: "Ausgewählt",
  },
  feedback: {
  ...
  parametricTips: {
    ...
    sheetMatchTitle: "Warum sie zu deiner Küche passt",
  ...
  cooking: {
    ...
    preCookAdapt: "An meine K\u00FCche anpassen",
    preCookStart: "Trotzdem starten",
    matchTones: {
      t90: {
        title: "Liebe auf den ersten Blick",
        canonical: "Das kanonische Rezept und deine K\u00FCche sprechen bereits dieselbe Sprache.",
        adapted: "Diese Version ist f\u00FCr dein Setup gemacht.",
      },
      t75: {
        title: "Ein starkes Duo",
        canonical: "Ein paar Mikro-Kompromisse, aber der Funke ist da.",
        adapted: "Wenige Anpassungen, viel Substanz.",
      },
      t60: {
        title: "Braucht etwas Werben",
        canonical: "Das kann gut werden: entsperre sie und Vulcan regelt Zeiten und Backen.",
        adapted: "Das Rezept funktioniert, verlangt aber etwas Aufmerksamkeit.",
      },
      t40: {
        title: "Gut Ding will Weile haben",
        canonical: "Das Rezept ist anspruchsvoll: besser erst an deinen Ofen anpassen.",
        adapted: "Gute Richtung, aber es braucht noch Kompromisse.",
      },
      t0: {
        title: "Gebrochenes Herz",
        canonical: "Wundersch\u00F6n, aber heute verlangt sie mehr Feuer, als du hast. Machen wir sie m\u00F6glich?",
        adapted: "Zu viel f\u00FCr dieses Setup: reduzieren wir Zeiten, Ofen oder Ambition.",
      },
    },
    ceilingUnviableOven:
      "Selbst im besten Fall erreichst du {ceiling}/100: dein Ofen schafft es nicht. Besser ein Stil f\u00FCr zuhause.",
    ceilingUnviable: "Selbst im besten Fall erreichst du {ceiling}/100 mit diesem Setup: lohnt sich nicht.",
    ceilingOvenWall: "Dein Ofen begrenzt dich auf {ceiling}/100: kein Leoparden-Muster, aber eine gute Pizza.",
    ceilingNeeds: "Um {ceiling}/100 zu erreichen, brauchst du: {needs}.",
    ceilingNeedsAtCeiling: "Diese Version setzt voraus: {needs}.",
    ceilingOptimize: "Mit Optimierung erreichst du {ceiling}/100 \u2014 du hast schon alles.",
    ceilingCanonicalOk: "Auch das kanonische Rezept funktioniert mit deinem Setup.",
    ceilingCompromise: "Dein Maximum mit diesem Setup ist {ceiling}/100: eine Kompromiss-Version.",
    needFlour: "ein Mehl um W{w}",
    makePossible: "Mach sie m\u00F6glich",
    ...
    recipeAdapted: "Für dich angepasst",
    ...
    matchDetailsHide: "Ausblenden",
    unsavedTitle: "Ungespeicherte Änderungen",
    unsavedBody: "Wenn du jetzt gehst, geht deine Version von {style} verloren. Im Rezeptbuch speichern?",
    unsavedDiscard: "Ohne Speichern verlassen",

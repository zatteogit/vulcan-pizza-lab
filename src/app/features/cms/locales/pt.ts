...
export const PT_LOCALE: CmsContent = {
  ...
  tips: {
    kitchenTemp:
      "A temperatura da cozinha influencia a velocidade da fermenta̤̣o. O motor adapta automaticamente tempos e quantidades.",
    timeSlot:
  ...
  profile: {
    ...
    savedRecipesSubtitle: "As vers̵es sob medida que voc̻ guardou",

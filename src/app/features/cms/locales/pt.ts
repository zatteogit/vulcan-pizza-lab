...
export const PT_LOCALE: CmsContent = {
  ...
  ui: {
    ...
    statFlourStrength: "Força da farinha",
    fermentEnvAmbient: "ambiente",
    fermentEnvFridge: "geladeira",
  ...
  misc: {
    ...
    inspirationModalTitle: "Interpretações de autor",
    inspirationLearnLink: "Saiba mais na seção Aprenda",
    inspirationSelect: "Selecionar",
    inspirationSelected: "Selecionada",
  },
  feedback: {

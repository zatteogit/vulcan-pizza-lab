...
export const ES_LOCALE: CmsContent = {
  ...
  ui: {
    ...
    statFlourStrength: "Fuerza de harina",
    fermentEnvAmbient: "ambiente",
    fermentEnvFridge: "nevera",
  ...
  misc: {
    ...
    inspirationBase: "Tradicional",
    inspirationSeeAll: "Ver todas",
    inspirationModalTitle: "Interpretaciones de autor",
    inspirationLearnLink: "Descubre más en la sección Aprende",
    inspirationSelect: "Seleccionar",
    inspirationSelected: "Seleccionada",
  },
  feedback: {

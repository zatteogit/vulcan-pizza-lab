...
const DERIVED_STYLE_SEEDS: DerivedStyleSeed[] = [
  ...
  },
  {
    ...
    panShape: "round",
    thickness_mm: 8,
    stretchMethod: "Dischetti piccoli stesi a mano, ripieni a mezzaluna e sigillati",
    restAfterBall_min: 30,
    saltPct: 2.5,
    hydrationCenter: 62.5,
    fermentation: [4, 8],
    ...
    topping: { toppingOrder: ["ripieno", "sigillatura", "frittura"], saucePosition: "nessuna", cheeseType: "Ricotta/provola", cheesePosition: "interno", note: "Farcita con ricotta, provola e cicoli all'interno e sigillata prima di friggere." },
    folding: { foldType: "none", foldCount: 0, foldInterval_min: 0, note: "Impasto diretto breve: non servono pieghe." },
    scoring: { scoringRequired: false, scoringType: "nessuno", scoringDepth_mm: 0, scoringTiming: "", note: "Sigillare bene prima della frittura." },
  ...
  {
    styleId: "pizza_montanara",
    name: "Pizza Montanara",
    doughWeight_g: 100,
    panSize_cm: 14,
    panShape: "round",
    thickness_mm: 8,
    stretchMethod: "Dischetti piccoli stesi a mano, fritti vuoti e conditi caldi sopra",
    restAfterBall_min: 30,
    saltPct: 2.5,
    hydrationCenter: 62.5,
    fermentation: [4, 8],
    ...
    oven: { idealTemp_c: 185, minTemp_c: 180, maxTemp_c: 190, ovenType: "frittura", preheatingMin: 15, note: "Derivato da STYLES_DB: temperatura dell'olio, non del forno." },
    baking: { minSeconds: 60, maxSeconds: 120, idealSeconds: 90, turns: 1, note: "Girare in olio caldo fino a gonfiore e doratura." },
    topping: { toppingOrder: ["frittura", "pomodoro", "condimento_a_crudo"], saucePosition: "sopra", cheeseType: "Ricotta/pecorino", cheesePosition: "sopra_salsa", note: "Fritta vuota e condita a caldo dopo la frittura con pomodoro, ricotta e pecorino." },
    folding: { foldType: "none", foldCount: 0, foldInterval_min: 0, note: "Impasto diretto breve: non servono pieghe." },
    scoring: { scoringRequired: false, scoringType: "nessuno", scoringDepth_mm: 0, scoringTiming: "", note: "Nessuna incisione." },
    equipment: { mixerRequired: false, mixerType: "manuale", mixingTime_min: 10, surfaceType: "padella", specialEquipment: ["Pentola alta", "Termometro olio", "Schiumarola"], note: "Controllo della temperatura olio fondamentale." },
  },
  {

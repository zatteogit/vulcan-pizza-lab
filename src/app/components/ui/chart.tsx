...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter) {
      return (
        <div className={cn("", labelClassName)} style={{ fontWeight: "var(--weight-medium)" as any }}>
    ...
    return <div className={cn("", labelClassName)} style={{ fontWeight: "var(--weight-medium)" as any }}>{value}</div>;
  }, [
    label,
    labelFormatter,
    payload,
  ...
  return (
    <div
      className={cn(
        "border-border/50 bg-background grid min-w-[8rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 shadow-xl",
        className,
      )}
    >
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <div style={{ display: "contents" }}>
                  ...
                  >
                    ...
                    {item.value && (
                      <span className="text-foreground font-mono tabular-nums" style={{ fontWeight: "var(--weight-medium)" as any }}>

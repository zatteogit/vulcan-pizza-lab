...
export const JA_LOCALE: CmsContent = {
  ...
  engineMessages: {
    ...
    "tip.waterTempCold":
      "55の法則: 冷蔵庫の水を使用してください ({temp}°C)。ミキサーが生地を温めます。",
    "tip.waterTempNormal":
      "55の法則: {temp}°Cの水を使って{ddt}°Cの生地温度を目指してください。",
    "tip.frictionNote": "ミキサー摩擦補正: {friction}°C",
  },
  scienceLabels: {
    yeastBaker: "\u30D1\u30F3\u7528\u30A4\u30FC\u30B9\u30C8",
    effectiveHours: "\u6709\u52B9\u6642\u9593",
  ...
  timelineLabels: {
    ...
    bulk: {
      ...
      tipNerd:
        "{temp}\u00B0C\u3067\u306E\u767A\u9175\u901F\u5EA6\u306F18\u00B0C\u57FA\u6E96\u306E{factor}\u00D7\u3067\u3059\u3002",
    },
    bulk_cold: {
      title: "\u4E00\u6B21\u767A\u9175",
      desc: "{temp}\u00B0C\u3067\u4E00\u6B21\u767A\u9175",
      ...
      tipNerd:
        "{temp}\u00B0C\u3067\u306FQ\u2081\u2080\u22482.0\u304C\u767A\u9175\u3092\u6E1B\u901F\u3002\u30BF\u30F3\u30D1\u30AF\u5206\u89E3\u6D3B\u6027\u304C\u512A\u52E2\u3068\u306A\u308A\u3001FODMAP\u3092\u5206\u89E3\u3057\u307E\u3059\u3002",
    },
    divide: {
      title: "\u5206\u5272",
      desc: "\u6B63\u3057\u3044\u91CD\u3055\u306B\u5206\u5272\u3057\u3001\u4E38\u3081\u308B\u3002",
    ...
    bake: {
      ...
      tipNerd:
        "\u30E1\u30A4\u30E9\u30FC\u30C9\u53CD\u5FDC\u306F\u7D04140\u00B0C\u3067\u59CB\u307E\u308A\u6307\u6570\u95A2\u6570\u7684\u306B\u52A0\u901F\u3002{temp}\u00B0C\u3067\u306F\u30AB\u30E9\u30E1\u30EB\u5316\u304C\u7D04600\u306E\u82B3\u9999\u5316\u5408\u7269\u3092\u751F\u6210\u3057\u307E\u3059\u3002",
    },
  },
  timelineUi: {
    startLabel: "\u958B\u59CB",
  ...
  configurator: {
    ...
    fermentLabel: "\u767A\u9175",
    fermentTip:
      "\u7DCF\u767A\u9175\u6642\u9593\u3002\u4F4E\u6E29\u3067\u9577\u6642\u9593\u307B\u3069\u8907\u96D1\u306A\u98A8\u5473\u3068\u826F\u3044\u6D88\u5316\u6027\u304C\u5F97\u3089\u308C\u307E\u3059\u3002",
    tempFridge: "4\u00B0C \u51B7\u8535\u5EAB",
    tempCool: "12\u00B0C",
    tempAmbient: "22\u00B0C \u5BA4\u6E29",

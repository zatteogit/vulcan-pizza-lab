...
import type { SkillLevel } from "./pizza-engine";
  ...
  bonci_teglia: [
    {
      ...
      label: "Leggerissima",
      emoji: "🍃",
      description: "Sottile e digeribile: 75%, 24h, ~600g/teglia (Malati di Pizza)",
      skill_hint: 1,
      ranges: {
      ...
      params: {
        ...
        dough_weight_g: 600, // 0.5 g/cm² su teglia 30x40 — pizza più sottile e accessibile
      },
    },
    {
      id: "bonci_casalingo",
      label: "Casalingo",
      emoji: "🏠",
      description: "Bonci accessibile: 78%, 24h, ~720g/teglia (media altezza)",
      skill_hint: 2,
      ranges: {
      ...
      params: {
        ...
        fermentation_temp_c: 4,
        use_pre_ferment: false,
        dough_weight_g: 720, // 0.6 g/cm² — pizza media altezza, coerente con "Casalingo"
      },
    },
    {
      id: "bonci_pizzarium",
      label: "Pizzarium",
      emoji: "☁️",
      description: "Bonci da scuola: 85%, 48h, 900g/teglia (mollica nuvola)",
      skill_hint: 3,
      params: {
        hydration_pct: 85,
        flour_w: 320,
    ...
    },
    {
      ...
      params: {
        ...
        fermentation_temp_c: 4,
        use_pre_ferment: false,
        dough_weight_g: 960, // 0.8 g/cm² — pizza estrema
      },
    },
  ],
